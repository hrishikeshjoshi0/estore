...
environments {
    development {
		...
		grails.serverURL = "http://localhost:9090/estore"
		
		dataSource {
			dbCreate = "update" // one of 'create', 'create-drop','update'
			url = "jdbc:mysql://localhost:3306/estore?useUnicode=yes&characterEncoding=UTF-8"
			username = "root"
			password = "admin"
			pooled=true
			properties {
	...
	test {
		grails.paypal.server = "https://www.sandbox.paypal.com/cgi-bin/webscr"
		grails.paypal.email = "nachi1_1337118253_biz@gmail.com"
		grails.serverURL = "http://localhost:8080/estore"
