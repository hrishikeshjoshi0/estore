...
<title>Product | Bella Sophia</title>
</head>
<body>
	<div class="container">
		...
		<div class="row">
			<div class="span15">
				<h2>Checkout</h2>
				<p class="show-login">
					Already registered ? <a href="account.html">Click here to login</a>
				</p>
			</div>
		</div>

		<div class="row">
			<div class="span7 checkout">
				<h3 class="billing-adress">Billing Address</h3>
				<form class="form-horizontal">
					...
					<div class="control-group">
						<label class="control-label" for="inputfirstname">Last
							Name<span class="required">*</span>
						</label>
						<div class="controls">
					...
					<div class="control-group">
						<label class="control-label" for="inputfirstname">Company
							Name</label>
						<div class="controls">
					...
					<div class="control-group">
						<label class="control-label" for="inputfirstname">Address<span
					...
					<div class="control-group">
						<label class="control-label" for="inputfirstname">Address
							2</label>
						<div class="controls">
					...
					<div class="control-group">
						<label class="control-label" for="inputfirstname">Town/City<span
							class="required">*</span></label>
						<div class="controls">
					...
					<div class="control-group">
						<label class="control-label" for="inputfirstname">Postcode<span
							class="required">*</span></label>
						<div class="controls">
					...
					<div class="control-group">
						<label class="control-label" for="inputfirstname">Country<span
							class="required">*</span></label>
						<div class="controls">
							<select>
					...
					<div class="control-group">
						<label class="control-label" for="inputfirstname">County</label>
						<div class="controls">
							<input type="text" placeholder="County">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="inputfirstname">Email
					...
					<div class="control-group">
						<label class="control-label" for="inputfirstname">Phone<span
							class="required">*</span></label>
						<div class="controls">
			...
			<div class="span8">
				<div class="shiptobilling clearfix">
					...
					<label class="checkbox"> <input type="checkbox" value=""
						onclick="jQuery('.shipping-address').toggle()">Ship to
						billing address?
					</label>
				</div>
			...
			<div class="span15">
				<div class="your_order">
					...
					<label class="radio" onclick="jQuery('.transfer').toggle()">
						...
						value="option1" checked> Direct Bank Transfer
					</label>
					<div class="transfer">
						<p>Make your payment directly into our bank account. Please
							use your Order ID as the payment reference. Your order wont be
